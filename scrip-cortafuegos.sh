...
iptables -A FORWARD -o eth0 -p tcp -m tcp --sport 80 -m state
...
iptables -A FORWARD -s 192.168.2.2 -d 192.168.1.2 -p tcp --dport
3306 -j ACCEPT
iptables -A FORWARD -s 192.168.1.2 -d 192.168.2.2 -p tcp --sport
3306 -j ACCEPT
...
iptables -A FORWARD -i eth1 -o eth2 -d 192.168.2.2 -p tcp -m tcp
--dport 80 -j ACCEPT
iptables -A FORWARD -i eth2 -o eth1 -s 192.168.2.2 -p tcp -m tcp
--sport 80 -m state --state RELATED,ESTABLISHED -j ACCEPT
echo "Hablitando acceso a ssh para poder documentar practica...
(debug mode)"
iptables -A OUTPUT -p tcp --dport 22 -j ACCEPT
iptables -A INPUT -p tcp --sport 22 -m state --state
RELATED,ESTABLISHED -j ACCEPT 